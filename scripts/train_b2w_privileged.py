"""Dedicated launcher for B2W privileged wheel-legged training."""
...
class B2WPrivilegedTrainConfig:
  """High-level options for the B2W capability-validation run."""

  num_envs: int = 4096
  max_iterations: int = 20000
  seed: int = 42
  run_name: str = "privileged"
...
def main() -> None:
  args = tyro.cli(B2WPrivilegedTrainConfig)
  if args.num_envs <= 0:
